...
const Cell = React.memo(({ index, cellData, onClick, isWinningCell }) => {
  const cellClasses = classNames(
    'flex items-center justify-center w-24 h-24 sm:w-28 sm:h-28 md:w-32 md:h-32 lg:w-40 lg:h-40', // Responsive sizing
    ...
    {
      'winning-cell bg-green-300 transform scale-105 shadow-lg': isWinningCell, // Highlight winning cells
      'cursor-not-allowed opacity-70': cellData, // Dim occupied cells
      'animate-pop-in': cellData, // Animation for new emoji placement
    }
  );
